      ...
      <div className="grid lg:grid-cols-2">
        <div className="relative min-h-[420px] lg:min-h-[560px]">
          <div
            ...
            style={{
              backgroundImage:
                'url(https://images.unsplash.com/photo-1558036117-15d82a90b9b1?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
            }}
          />
          <div className="absolute inset-0 bg-gradient-to-r from-ink/0 to-ink/15 lg:to-ink/50" />
        ...
        <div className="wood-grain flex items-center px-6 py-16 sm:px-10 lg:px-16 lg:py-24">
          <div className="max-w-lg">
            ...
            <h2 className="mt-4 font-display text-4xl leading-tight font-medium text-oak sm:text-5xl">
              Built for prairie weather.
              <br />
              <span className="italic text-brass">Finished by hand.</span>
            </h2>
            <p className="mt-6 leading-relaxed text-oak">
            ...
            <p className="mt-4 leading-relaxed text-oak">
            ...
            <ul className="mt-10 space-y-4">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-sm text-oak">
